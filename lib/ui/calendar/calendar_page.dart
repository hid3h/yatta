        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final isCompletedOnSelectedDay =
                  task.isCompletedOnDate(_selectedDay!);
              ...
              return Card(
                ...
                color: isCompletedOnSelectedDay
                  ...
                  title: Text(
                    ...
                    style: TextStyle(
                      color: isCompletedOnSelectedDay
                          ? task.color
                          : null,
                      fontWeight: isCompletedOnSelectedDay
                          ? FontWeight.w500
                          : FontWeight.normal,
                    ),
                  ),
                  trailing: isCompletedOnSelectedDay
                      ? Icon(
                          Icons.check_circle,
                          color: task.color,
                        )
